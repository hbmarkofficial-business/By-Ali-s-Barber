  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | By Ali‘s Barber</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop By Ali‘s Barber in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="By Ali‘s Barber | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="By Ali‘s Barber | Premium Barbershop Berlin" />
        <meta
